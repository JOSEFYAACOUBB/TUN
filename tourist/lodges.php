...
<div class="container py-4">
    <h1 class="mb-4">Eco-Lodges</h1>
    
    <div class="row">
        <?php foreach ($lodges as $lodge): ?>
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <img src="<?php echo $lodge['image_url']; ?>" class="card-img-top" alt="<?php echo $lodge['name']; ?>">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5 class="card-title"><?php echo $lodge['name']; ?></h5>
                            <span class="badge bg-success"><?php echo $lodge['sustainability_score']; ?>% Sustainable</span>
                        </div>
                        <p class="card-text text-muted">
                            <i class="fas fa-map-marker-alt"></i> <?php echo $lodge['location']; ?>
                        </p>
                        <p class="card-text"><?php echo $lodge['description']; ?></p>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-success fw-bold"><?php echo $lodge['price_per_night']; ?>/night</span>
                            <a href="bookings.php?lodge_id=<?php echo $lodge['id']; ?>" class="btn btn-sm btn-success">Book Now</a>
                        </div>
                    </div>
                </div>
            </div>
